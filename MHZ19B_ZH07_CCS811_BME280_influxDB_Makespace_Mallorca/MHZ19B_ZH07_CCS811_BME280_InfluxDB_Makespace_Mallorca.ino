...
{ 
  ...
  // Read all the other values
    ...
    sprintf(fields,"CO2[ppm]=%d,T[°C]=%0.2f,accuracy[o/o]=%0.2f,CO2_min[ppm]=%d,PM1.0[µg/m³]=%d,PM2.5[µg/m³]=%d,PM10[µg/m³]=%d,eCO2[ppm]=%d,TVOC[ppb]=%d,T[°C]=%0.2f,p[hPa]=%0.2f,rH[o/o]=%0.2f,baseline=%d",val_CO2,val_tempC,val_accCO2,val_minCO2,val_PM1_0,val_PM2_5,val_PM10,val_eCO2,val_TVOC,BMEtempC,BMEpres,BMEhumid,currBaseline); // escribir valores: CO2, Temperatura, accuracy y CO2_min
